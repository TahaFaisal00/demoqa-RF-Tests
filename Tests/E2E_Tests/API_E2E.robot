...
Full User Experience Via API
    ...
    Verify Books In Response    ${response}                 ${GIT_POCKET_GUIDE_ISBN}        ${LEARNING_JAVASCRIPT_DESIGN_PATTERNS_ISBN}
    ${response}=        Update Book By Another Via API    ${LEARNING_JAVASCRIPT_DESIGN_PATTERNS_ISBN}    ${SPEAKING_JAVA_SCRIPT_ISBN}
    Verify Book Replaced        ${response}     ${LEARNING_JAVASCRIPT_DESIGN_PATTERNS_ISBN}         ${SPEAKING_JAVA_SCRIPT_ISBN}
